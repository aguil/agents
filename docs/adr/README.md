...
- [0002-triage-pathname-io-accepted-risk.md](0002-triage-pathname-io-accepted-risk.md) — ADR 0002: accepted risk for pathname-based triage I/O without `openat` (and discovery fallback cost).
